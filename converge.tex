...
Lemma~\ref{lem:Bernoulli} is related to \emph{Bernoulli's inequality} \cite{MitrinovicAI}.
...
\begin{proof}
  ...
  Let $n \in \bN$.
  $$
  u_{n + 1} = \left( \frac{n + 2}{n + 1} \right)^{n + 1}
  $$
   $$
   u_n = \left( \frac{n + 1}{n} \right)^{n + 1} \frac{n}{n + 1} 
   $$
   $$
